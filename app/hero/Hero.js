...
import {About_content} from '../../public/img/about.jpg';
...
const Hero = () => {
  return (
    <>
      <Noisy height="200vh" className="test"/>
      ...
      <section id="about" className="text-white w-[100vw] h-[100vh] bg-black overflow-hidden">
        <div>
          <div className={`${Ogg.className} max-w-none p-2 text-[3.6vh] md:max-w-[45rem] 2xl:max-w-[70rem] md:p-4 2xl:text-[5.1vh] tracking-tighter`}>
      ...
      <section className={`${Ogg.className} w-[100vw] h-[80vh] md:h-[100vh] bg-black text-white xl:h-[80vh] pt-0 2xl:pt-[2rem]`}>
        <div className="relative">
          <div className="">
                ...
                <div className="text-[2.7vh] md:text-[2vh] flex flex-row justify-between space-x-0 p-0 lg:p-4 xl:mr-[2rem]">
                  <div className="p-2 tracking-tighter hidden md:block">
                    <p>Cogito</p>
                    <p>Discens</p>
                  </div>
                  ...
                  <div className="p-2 text-start space-y-1"> 
                    ...
                    <p className="tracking-widest">+62 82383978374</p>
                  </div>
