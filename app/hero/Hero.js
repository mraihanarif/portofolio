  ...
  useEffect(() => {
    ...
    .to(progressBarRef.current, {
      ...
      .to(loadingTextRef.current, {
        ...
        duration: 0.5,
        ease: "power1.inOut",
      }, "-=1") // Fade out loading text while bar animation is finishing
      ...
      .from(containerRef.current, {
        ...
        duration: 1,
        ease: "power2.out",
      }, "-=0.5") // Hero section slides up as preloader goes away
  }, []);
    ...
    <>
      ...
      >
        <div className="flex flex-col leading-tight text-[2.5rem] lg:text-[5rem] xl:text-[4rem] font-extrabold">
          <div
           ref={text1}  className="absolute top-[15vh] lg:top-[10vh] left-0 lg:left-[5vw] xl:left-[3vw] px-4 text-start"
          >
            <h1>
              <span className={`${Ogg1.className} text-[3rem] lg:text-[9rem] xl:text-[7rem]`}>
                D
              </span>
              EVELOPER
            </h1>
            ...
            <h1>
              ...
              OR UR <span className={`text-[3rem] lg:text-[9rem] xl:text-[7rem]`}>W</span>EBSITE
            </h1>
          </div>
          <div
            ref={text2} className="absolute bottom-[15vh] lg:bottom-[10vh] xl:bottom-[1vh] right-0 lg:right-[5vw] xl:right-[6vw] text-end px-4"
          >
            <h1>
              <span className={`${Ogg1.className} text-[3rem] lg:text-[9rem] xl:text-[7rem]`}>
                B
        ...
        <div ref={text3} className="absolute bottom-0 left-0 p-2 font-extrabold">
          <p>SCROLL</p>
        </div>
      </section>
    </>
